...
public class LinearSearch {
	 ...
	 * @param arr is a array object which holds list of numbers
	 * @param x is the element which for using to find the index
	 * @return exact index value if the element is available in the array otherwise -1
	 */
